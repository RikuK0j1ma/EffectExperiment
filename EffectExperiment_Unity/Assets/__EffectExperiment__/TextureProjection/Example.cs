...
public class Example : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        _material.SetMatrix("_ProjectorMatrixVP", projectionMatrix * viewMatrix);
        _material.SetTexture("_ProjectorTexture", _texture);
        // プロジェクターの位置を渡す
        ...
        _material.SetVector("_ProjectorPos", projectorPos);
    }

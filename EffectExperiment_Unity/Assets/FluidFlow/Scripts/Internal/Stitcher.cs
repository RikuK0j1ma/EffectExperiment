...
namespace FluidFlow
{
    ...
    public static class Stitcher
    {
        ...
        public class GenerationHandle : System.IDisposable
        {
            ...
            public GenerationHandle(Mesh from, UVSet uvSet)
            {
                ...
                for (var i = 0; i < GenerationResults.Length; i++) {
                    ...
                    // if this line errors because of 'SortJob', please make sure you have the `com.unity.collections` package installed (https://christianschott.github.io/docs/fluidflow/book/index.html#required-unity-packages)
        ...
        // if this line errors because of 'BurstCompileAttribute', please make sure you have the `com.unity.burst` package installed (https://christianschott.github.io/docs/fluidflow/book/index.html#required-unity-packages)
        [BurstCompile]
